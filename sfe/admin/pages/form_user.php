...
<div class="sidenav-header">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
    <div class="card-body"> <h6>Add Users Manuelly</h6>
    <div class="card-header pb-0">
                ...
                <form role="form text-left" action="./add.php" method="POST" >
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="description" class="form-control" placeholder="description" aria-label="description" aria-describedby="email-addon">
                  </div>
                  <div class="mb-3">
                  ...
                  <label> Confirm Password</label>
                    <input type="password" name="cpassword" class="form-control" placeholder="Confirmed Password" aria-label="Confirmed_Password" aria-describedby="password-addon">
                  </div>
                 
                  <div class="text-center">
                    <input type="submit" name="submit_u"  value="Register" class="btn bg-gradient-dark w-100 my-4 mb-2" >Add user</input>
                  </div>
                 </form>
              </div>
              </div>
