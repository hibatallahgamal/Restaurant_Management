        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card z-index-2">
            <div class="card-body p-3">
              ...
              <h6 class="ms-2 mt-4 mb-0"> Clients  </h6>
...
var gradientStroke1 = ctx2.createLinearGradient(0, 0, 170, 0);

gradientStroke1.addColorStop(1, 'white');
gradientStroke1.addColorStop(0.2, 'white');
gradientStroke1.addColorStop(0, 'white'); //purple colors

var gradientStroke2 = ctx2.createLinearGradient(0, 0, 170, 0);

gradientStroke2.addColorStop(1, 'black');
gradientStroke2.addColorStop(0.2, 'black');
...
new Chart(ctx2, {
  ...
  data: {
    labels:<?php
            ...
            $sql  = "SELECT name , COUNT(*) FROM sign_up_client GROUP BY name  LIMIT 10;";
            $chartres = mysqli_query($conn, $sql);
            $resultCheck = mysqli_num_rows($chartres);
            echo "[";
            if($resultCheck > 0){
  ...
  options: {
    ...
    gradientStroke1.addColorStop(1, 'orange');
      ...
      data: {
        labels:<?php
                ...
                $database = "odeo_restau";
                 ...
                 // Create a connection 
                 $conn = mysqli_connect($servername, $username, $password, $database);
                $sql  = "SELECT r_date , COUNT(*) FROM r_table GROUP BY time  LIMIT 10;";
                $chartres = mysqli_query($conn, $sql);
                $resultCheck = mysqli_num_rows($chartres);
                echo "[";
                if($resultCheck > 0){
                  while($row = mysqli_fetch_assoc($chartres)){ 
                    print_r("'".$row['r_date']."',");}} echo "]"; ?>
                ,
        datasets:[{
            label: "Mobile apps",
            tension: 0.4,
