      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid pe-0">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="../pages/Sign_in.php">
               Sign In
            </a>
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" action="verification.php" method="POST">
                    ...
                    <input type="submit" name="submit_sign_in"  value="Register" class="btn bg-gradient-info  w-100 mt-4 mb-0" >Sign in</input>
                    </div>
                    <?php
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="../pages/sign_up.php" class="text-info text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
