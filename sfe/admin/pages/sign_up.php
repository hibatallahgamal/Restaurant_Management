...
<body class="">
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
      <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="../pages/sign_up.php">
        Sign Up
      </a>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">Register in the  form below  to  create an account. </p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form text-left" action="./code.php" method="POST" >
                  <div class="mb-3">
                  ...
                  <div class="text-center">
                    <input type="submit" name="submit"  value="Register" class="btn bg-gradient-dark w-100 my-4 mb-2" >Sign up</input>
                  </div>
                  <p class="text-sm mt-3 mb-0">Already have an account? <a href="../pages/sign_in.php" class="text-dark font-weight-bolder">Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
