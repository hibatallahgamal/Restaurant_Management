...
<div class="sidenav-header">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add dish</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Add Dish</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
    <div class="card-body"> <h6>Add Dishe's to menu</h6>
    <div class="card-header pb-0">
             
             
            </div>
                <form role="form text-left" action="./add_m.php" method="POST" >
                <div class="mb-3">
                      <label>Id</label>
                    <input type="text" name="id" class="form-control" placeholder="id" aria-label="id" aria-describedby="email-addon">
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="ingrediants" class="form-control" placeholder="ingrediants" aria-label="ingrediants" aria-describedby="email-addon">
                  </div>
                  <div class="mb-3">
                  <label>Price</label>
                    <input type="text" name="price" class="form-control" placeholder="price" aria-label="price" aria-describedby="password-addon">
                  </div>
                 
                 
                  <div class="text-center">
                    <input type="submit" name="submit_m"  value="Register" class="btn bg-gradient-dark w-100 my-4 mb-2" >Add Dish</input>
                  </div>
                 </form>
              </div>
              </div>
