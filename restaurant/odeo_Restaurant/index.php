...
<body>
    ...
    <div id="topbar" class="d-flex align-items-center fixed-top">
        <div class="container d-flex justify-content-center justify-content-md-between">
            ...
            <div class="contact-info d-flex align-items-center">
                <i class="bi bi-phone d-flex align-items-center"><span>++212 661-453373</span></i>
    ...
    <header id="header" class="fixed-top d-flex align-items-cente">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
            ...
            <h1 class="logo me-auto me-lg-0"><a href="index.html">Odeo Restaurants</a></h1>
            ...
            <a href="../odeo_Restaurant/cart.php">
                <img src="assets/img/cart_ico.ico" width="28px" height="28px">
            </a>
        </div>
    </header><!-- End Header -->
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
            <div class="row">
                <div class="col-lg-8">
                    <h1>Welcome to <span>Odeo Restaurants</span></h1>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 p-4 pt-lg-0 order-2 order-lg-1 content">
                        <h3>Odeo Restaurants</h3>
                        <p class="fst-italic">
                ...
                <dIV class="row menu-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                        ...
                        <div class="menu-content">
                            Lobster Bisque <a href="add_cart.php?id=1"><span>$5.95</span></a>
                    ...
                    <div class="col-lg-6 menu-item filter-specialty">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=2">Bread Barrel</a><span>$6.95</span>
                        </div>
                        <div class="menu-ingredients">
                            Lorem, deren, trataro, filede, nerada
                        </div>
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=3">Crab Cake</a><span>$7.95</span>
                        </div>
                        <div class="menu-ingredients">
                    ...
                    <div class="col-lg-6 menu-item filter-salads">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=4">Caesar Selections</a><span>$8.95</span>
                        </div>
                        <div class="menu-ingredients">
                            Lorem, deren, trataro, filede, nerada
                        </div>
                    ...
                    <div class="col-lg-6 menu-item filter-specialty">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=5">Tuscan Grilled</a><span>$9.95</span>
                        </div>
                        <div class="menu-ingredients">
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=6">Mozzarella Stick</a><span>$4.95</span>
                        </div>
                        <div class="menu-ingredients">
                            Lorem, deren, trataro, filede, nerada
                        </div>
                    ...
                    <div class="col-lg-6 menu-item filter-salads">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=7">Greek Salad</a><span>$9.95</span>
                        </div>
                        <div class="menu-ingredients">
                    ...
                    <div class="col-lg-6 menu-item filter-salads">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=8">Spinach Salad</a><span>$9.95</span>
                        </div>
                        <div class="menu-ingredients">
                    ...
                    <div class="col-lg-6 menu-item filter-specialty">
                        ...
                        <div class="menu-content">
                            <a href="add_cart.php?id=10">Lobster Roll</a><span>$12.95</span>
                        </div>
                        <div class="menu-ingredients">
                ...
                <form action="book-a-table.php" method="post" role="form" class="php-email-form" data-aos="fade-up"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 form-group mt-3">
                            <input type="text" name="r_date" class="form-control" id="date" placeholder="Date"
                                data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                            <div class="validate"></div>
                        </div>
                        <div class="col-lg-4 col-md-6 form-group mt-3">
                        ...
                        <div class="col-lg-4 col-md-6 form-group mt-3">
                            <input type="number" class="form-control" name="nbr_ppl" id="people"
                    ...
                    <div name="b_table" class="text-center">
                        <input type="submit" name="book_table" id="submit" class="form-control" value="Book a Table" />
                    </div>
                </form>
        ...
        <section id="contact" class="contact">
            ...
            <div data-aos="fade-up">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28168786.526442017!2d-20.80919008338947!3d30.47654244908519!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdafed2621557d39%3A0x6021a582efd71b63!2sOdeo!5e0!3m2!1sen!2sma!4v1652214662885!5m2!1sen!2sma"
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        ...
                        <form action="contact_us.php" method="post" role="form" class="php-email-form">
                            <div class="row">
    ...
    <footer id="footer">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-info">
                            ...
                            <p>
                                ...
                                <br>
                                Marrakech 40000 , Morocco<br><br>
                                <strong>Phone:</strong>+212 661-453373<br>
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Odeo Restaurants</span></strong>. All Rights Reserved
            </div>
            <div class="credits">

                Designed by <a href="">Odeo Systems</a>
            </div>
        </div>
    </footer><!-- End Footer -->
